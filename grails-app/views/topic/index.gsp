		...
		<div id="list-topic" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="topicDescription" title="${message(code: 'topic.topicDescription.label', default: 'Topic Description')}" />
				...
				<g:each in="${topicInstanceList}" status="i" var="topicInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: topicInstance, field: "topicDescription")}</td>
