...
<div class="fieldcontain ${hasErrors(bean: subscriptionInstance, field: 'seriousness', 'error')} required">
	...
	<g:select name="seriousness" from="${com.intelligrape.linksharing.enums.Seriousness?.values()}" keys="${com.intelligrape.linksharing.enums.Seriousness.values()*.name()}" required="" value="${subscriptionInstance?.seriousness?.name()}" />
