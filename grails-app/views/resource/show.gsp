	...
	<body>
		...
		<div id="show-resource" class="content scaffold-show" role="main">
			...
			<ol class="property-list resource">
				...
				<g:if test="${resourceInstance?.resourceType}">
				<li class="fieldcontain">
					<span id="resourceType-label" class="property-label"><g:message code="resource.resourceType.label" default="Resource Type" /></span>
					
						<span class="property-value" aria-labelledby="resourceType-label"><g:fieldValue bean="${resourceInstance}" field="resourceType"/></span>
				...
				<g:if test="${resourceInstance?.reads}">
				<li class="fieldcontain">
					<span id="reads-label" class="property-label"><g:message code="resource.reads.label" default="Reads" /></span>
					
						<g:each in="${resourceInstance.reads}" var="r">
						<span class="property-value" aria-labelledby="reads-label"><g:link controller="resourceRead" action="show" id="${r.id}">${r?.encodeAsHTML()}</g:link></span>
						</g:each>
